			...
			<div class="row">
				...
				<ul class="col-xs-12 prod-list">
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/motel/areaList?location=mseoul" class="prod-link"> 
							<img src="${pageContext.request.contextPath }/resources/images/seoul.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/motel/areaList?location=mkangwon" class="prod-link">
							<img src="${pageContext.request.contextPath }/resources/images/kangwon.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/motel/areaList?location=mbusan" class="prod-link">
							<img src="${pageContext.request.contextPath }/resources/images/busan.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/motel/areaList?location=mjeju" class="prod-link">
