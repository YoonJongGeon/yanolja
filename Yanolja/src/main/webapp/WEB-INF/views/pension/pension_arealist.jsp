			...
			<div class="row">
				...
				<ul class="col-xs-12 prod-list">
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/pension/areaList?location=pseoul" class="prod-link"> 
							<img src="${pageContext.request.contextPath }/resources/images/seoul.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/pension/areaList?location=pkangwon" class="prod-link">
							<img src="${pageContext.request.contextPath }/resources/images/kangwon.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/pension/areaList?location=pbusan" class="prod-link">
							<img src="${pageContext.request.contextPath }/resources/images/busan.jpg">
						</a>
					</li>
					<li class="col-sm-12 col-lg-6 location">
						<a href="${pageContext.request.contextPath }/pension/areaList?location=pjeju" class="prod-link">
